...
const upcxx::team &split_rank::split_local_team() {
  ...
  DBG("Split split_node_rank_n ", split_node_rank_n, " for local_team.rank_n() = ", local_team().rank_n(), "\n");
...
split_team::split_team(const upcxx::team &full_, const upcxx::team &thread_)
  ...
  DBG("full=", full_me(), "of", full_n(), " node=", node_me(), "of", node_n(), " thread=", thread_me(), "of", thread_n(), "\n");
}
